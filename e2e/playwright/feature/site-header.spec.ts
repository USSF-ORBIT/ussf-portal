...
describe('Site header', () => {
  test('can create a Site Header and interact with it in the portal', async ({
    ...
    await page.getByLabel('Button label').click()
    await page.getByLabel('Button label').fill('News')
    await page.getByLabel('Button source').click()
    await page.getByLabel('Button source').fill('/news')
    await page.getByLabel('Dropdown label').click()
    await page.getByLabel('Dropdown label').fill('Dropdown')
